...
export namespace Images {
    ...
    export class ImagesBullet {
        static getName(): string { return 'bullet'; }

        static getPNG(): string { return require('assets/images/bullet.png'); }
    }
    export class SpritesheetsFire01 {
        static getName(): string { return 'Fire01'; }

        static getPNG(): string { return require('assets/spritesheets/Fire01.png'); }
    }
    export class SpritesheetsToonExplosion31 {
        static getName(): string { return 'ToonExplosion31'; }

        static getPNG(): string { return require('assets/spritesheets/ToonExplosion31.png'); }
    }
}

export namespace Spritesheets {
    export class SpritesheetsFireball646464 {
        static getName(): string { return 'fireball.[64,64,64,0,0]'; }

        static getPNG(): string { return require('assets/spritesheets/fireball.[64,64,64,0,0].png'); }
        static getFrameWidth(): number { return 64; }
        static getFrameHeight(): number { return 64; }
        static getFrameMax(): number { return 64; }
    ...
    export class SpritesheetsPlayer161622 {
        static getName(): string { return 'Player.[16,16,22,0,0]'; }

        static getPNG(): string { return require('assets/spritesheets/Player.[16,16,22,0,0].png'); }
        static getFrameWidth(): number { return 16; }
        static getFrameHeight(): number { return 16; }
        static getFrameMax(): number { return 22; }
        static getMargin(): number { return 0; }
        static getSpacing(): number { return 0; }
    }
}
